...
// below the binary's codeVersion opens normally.
...
func TestCompatWindowRefusesAtFloorBoundary(t *testing.T) {
	...
	// test tracks the constant — a literal would silently stop exercising
	// the boundary the moment codeVersion advances.
