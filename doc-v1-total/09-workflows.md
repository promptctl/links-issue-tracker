...
| `lit next` (`internal/cli/next.go:93`) | `next_pulled` | last, after the start advice and summary; only when a row was actually served — exhausted/no-work paths return before any occasion is built |
