...
Read commands that additionally print the store-backed banner: `internal/cli/cli.go:916`, `internal/cli/next.go:68`, `internal/cli/workable.go:185` (i.e. `show`-family, `next`, and `backlog`/workable views).
