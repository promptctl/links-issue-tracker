...
- Comparable wrong-usage refusals exit differently: family dispatch is a plain error (exit 1), while transition arity, `completion` arity, and every other per-command usage refusal are exit 2.
