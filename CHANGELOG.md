...
- The `guidance-<action>-<phase>.md` template mechanism (and its always-dead `pre` phase) is retired — `lit workflows` definitions are now the only path guidance reaches the agent through.
